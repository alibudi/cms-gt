        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title"><a href="{{ route('topic.create') }}" class="btn btn-success"> <i class="fa fa-plus"></i> New Topic</a></h3>
                    ...
                    <tr>
                        ...
                        <td>
                            <form action="{{ route('topic.destroy',$item->id) }}" method="POST"> 
                              <a class="btn btn-primary btn-xs" href="{{ route('topic.edit',$item->id) }}"><i class="fa fa-pencil"></i></a> 
                              @csrf
                              @method('DELETE')
